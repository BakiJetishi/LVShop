...
<footer aria-label="Site Footer" class="bg-gray-100 mt-20">
  ...
  >
    ...
    >
      ...
      <div>
        <p class="font-medium text-gray-900">Lorem</p>
    ...
    <p class="text-xs text-gray-500">
      &copy; 2023. LVshop. All rights reserved.
    </p>
  </div>
</footer>
