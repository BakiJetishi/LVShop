<aside class="w-full md:w-64 bg-gray-800 md:min-h-screen" x-data="{ isOpen: false }">
    ...
    <div class="px-2 py-6 md:block" >
        @if(auth()->user()->role == 1)
        <ul>
            <li class="px-2 py-3 {{ request()->is('admin/dashboard') ? 'bg-gray-900' : '' }} hover:bg-gray-900 rounded">
            ...
            <li class="px-2 py-3 {{ request()->is('admin/categories') ? 'bg-gray-900' : '' }} hover:bg-gray-900 rounded mt-2">
            ...
            <li class="px-2 py-3 {{ request()->is('admin/products') ? 'bg-gray-900' : '' }} hover:bg-gray-900 rounded mt-2">
            ...
            <li class="px-2 py-3 {{ request()->is('admin/create') ? 'bg-gray-900' : '' }} hover:bg-gray-900 rounded mt-2">
                <a href="/admin/create" class="flex items-center">
                    <svg class="w-6 text-gray-500" fill="none" stroke-linecap="round"
                         stroke-linejoin="round"
                         stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        <path
                    ...
                    <span class="mx-2 text-gray-300">Create Product</span>
                </a>
            </li>
            <li class="px-2 py-3 {{ request()->is('admin/category/create') ? 'bg-gray-900' : '' }} hover:bg-gray-900 rounded mt-2">
                <a href="/admin/category/create" class="flex items-center">
                    <svg class="w-6 text-gray-500" fill="none" stroke-linecap="round"
                         stroke-linejoin="round"
                         stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        <path
                    ...
                    <span class="mx-2 text-gray-300">Create Category</span>
                </a>
            </li>
        </ul>
        <div class="border-t border-gray-700 -mx-2 mt-"></div>
        <ul class="mt-6">
            <li class="px-2  hover:bg-gray-900 rounded mt-2">
                <a href="/account" class="mx-2 text-gray-300">Account Settings</a>
            </li>
        </ul>
        @else
        <div class="border-t border-gray-700 -mx-2 mt-"></div>
        ...
        @endif
        <ul class="mt-6">
            <li class="px-2 py-3 border-t border-gray-700 hover:bg-gray-900 rounded mt-2">
                <a href="/" class="mx-2 text-gray-300">Home</a>
            </li>
        </ul>
    </div>
</aside>
